                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Align(
                        ...
                        child: Text('Parolanı mı Unuttun?',style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 17,
                          color: Color(0xff4CAF50),
                        ),),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: const Center(child: Text('Giriş',style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 20,
                              color: Colors.white
                          ),),),
                      ...
                      const Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("Hala üye değil misin?",style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Color(0xff4CAF50)
                            ),),
                            Text("Üye ol",style: TextStyle(///done login page
                                fontWeight: FontWeight.bold,
                                fontSize: 17,
                                color: Color(0xff4CAF50)
                            ),),
